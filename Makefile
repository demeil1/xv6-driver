KERNOBJS = \
  ...
  syscall.o sysfile.o sysproc.o trapasm.o trap.o uart.o vectors.o vm.o vga.o display.o mouse.o\
#
...
UPROGS= \
	...
	_rm _sh _stressfs _usertests _wc _zombie _prettyprint _imshow _mario _mouse_test \
#
